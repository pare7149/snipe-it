                ...
                <div class="box-body">
                    <form class="form-horizontal" method="post" action="" autocomplete="off">
                       ...
                       'asset_ids' => old('selected_assets')
                        ...
                        @include ('partials.forms.edit.asset-select', ['translated_name' => trans('general.select_asset'), 'fieldname' => 'assigned_asset', 'company_id' => auth()->user()->company_id, 'unselect' => 'true', 'style' => session('checkout_to_type') === 'asset' ? '' : 'display: none;'])
