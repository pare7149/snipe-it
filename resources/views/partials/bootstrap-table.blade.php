    ...
    function genericCheckinCheckoutFormatter(destination) {
        return function (value, row) {
            ...
            // The user is allowed to check items in
                ...
                if (row.assigned_to) {
                    if (row.available_actions.update == true) return '<a target="_blank" href="{{ config('app.url') }}/' + destination + '/' + row.id + '/checkin" class="btn btn-sm bg-purple" data-tooltip="true" title="{{ trans('general.checkin_tooltip') }}">{{ trans('general.checkin') }}</a><a target="_blank" href="{{ config('app.url') }}/' + destination + '/' + row.id + '/update" class="btn btn-sm bg-orange ml-4" data-tooltip="true" title="{{ trans('general.checkin_tooltip') }}">{{ trans('general.update') }}</a>';
                    ...
                    if (row.available_actions.update == true)  return '<a target="_blank" href="{{ config('app.url') }}/' + destination + '/' + row.assigned_pivot_id + '/checkin" class="btn btn-sm bg-purple" data-tooltip="true" title="{{ trans('general.checkin_tooltip') }}">{{ trans('general.checkin') }}</a><a target="_blank" href="{{ config('app.url') }}/' + destination + '/' + row.assigned_pivot_id + '/update" class="btn btn-smbg-orange ml-4" data-tooltip="true" title="{{ trans('general.checkin_tooltip') }}">{{ trans('general.update') }}</a>';
