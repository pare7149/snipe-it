...
<<<<<<< HEAD
    'support_url_help' => 'Kintamieji: <code>{LOCALE}</code>, <code>{SERIAL}</code>, <code>{MODEL_NUMBER}</code> ir <code>{MODEL_NAME}</code> gali būti naudojami jūsų URL, kad šios reikšmės būtų automatiškai įvestos peržiūrint išteklius, pvz., https://checkcoverage.apple.com/{LOCALE}/{SERIAL}.',
=======
