...
>>>>>>> origin/upstream
    ...
    'accept_assets'         => 'Accepterade tillgångar :namn',
    ...
    'not_deleted'           => ':item_type blev inte borttagen och kan därför inte återställd',
    'create'				=> 'Skapa Ny',
...
>>>>>>> origin/upstream
    ...
    'filetypes_accepted_help'    => 'Tillåtna filtyper är :types. Maximalt tillåtna storlek är :size.|Tillåtna filtyper är :types. Maximalt tillåtna uppladdningsstorlek är :size.',
    'filetypes_size_help'   => 'Maximalt tillåtna uppladdningsstorlek är :size.',
    'image_filetypes_help'  => 'Tillåtna filtyper är jpg, webp, png, gif, svg och avif. Maximalt tillåtna uppladdningsstorlek är :size.',
    ...
    'next_audit_date_help'  => 'Om du använder inventering i din organisation, detta beräknas vanligtvis automatiskt baserat på tillgången&apos;s senaste inventeringsdatumet och Inventeringsintervall (i <code>Admininställningar &gt; Aviseringar</code>) och du kan lämna detta tomt. Du kan manuellt ställa in detta datum här om du behöver, men det måste vara senare än det senaste inventeringsdatumet. ',
    ...
    'qty'		            => 'Antal',
    'quantity'		        => 'Antal',
    'quantity_minimum'      => 'Du har ett objekt under eller nästan under minsta antalsnivå|Du har :count objekt under eller nästan under minsta antalsnivå',
...
>>>>>>> origin/upstream
    ...
    'audit_due_days'        => 'Tillgångar som ska granskas inom :days Day|Tillgångar som ska granskas inom :days dagar',
...
>>>>>>> origin/upstream
    ...
    'sad_panda' => 'Ledsen panda. Du har inte behörighet att göra det. Kanske <a href=":link">återgå till instrumentpanelen</a> eller kontakta din administratör.',
    'bulk' => [
            'delete' =>
                [
                'header' => 'Massradera :object_type',
                'warn'   =>  'Du är påväg att ta bort ett :object_type|Du är påväg att ta bort :count :object_type',
